...
namespace TwitchColony.Events
{
    ...
    public sealed class AthleticsUpEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: AthleticsUp"); ModEffects.ApplyToAll(ModEffects.AthleticsUp, "fast!"); }
    }
    ...
    public sealed class AthleticsDownEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: AthleticsDown"); ModEffects.ApplyToAll(ModEffects.AthleticsDown, "slow..."); }
    }
    ...
    public sealed class ConstructionUpEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: ConstructionUp"); ModEffects.ApplyToAll(ModEffects.ConstructionUp, "build!"); }
    }
    ...
    public sealed class ConstructionDownEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: ConstructionDown"); ModEffects.ApplyToAll(ModEffects.ConstructionDown, "oops"); }
    }
    ...
    public sealed class ExcavationUpEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: ExcavationUp"); ModEffects.ApplyToAll(ModEffects.ExcavationUp, "dig!"); }
    }
    ...
    public sealed class ExcavationDownEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: ExcavationDown"); ModEffects.ApplyToAll(ModEffects.ExcavationDown, "blunt"); }
    }
    ...
    public sealed class StrengthUpEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: StrengthUp"); ModEffects.ApplyToAll(ModEffects.StrengthUp, "strong!"); }
    }
    ...
    public sealed class StrengthDownEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: StrengthDown"); ModEffects.ApplyToAll(ModEffects.StrengthDown, "weak"); }
    }
    ...
    public sealed class SleepyDupesEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: SleepyDupes"); ModEffects.ApplyToAll(ModEffects.Sleepy, "yawn"); }
    }
    ...
    public sealed class SlowDupesEvent : GameEvent
    {
        ...
        public override void Trigger() { Log.Info("Event: SlowDupes"); ModEffects.ApplyToAll(ModEffects.SlowMo, "slow..."); }
    }
    ...
    public sealed class SleepNowEvent : GameEvent
    {
        ...
        public override void Trigger()
        {
            ...
            DupeUtil.ApplyAmountToAll(Db.Get().Amounts.Stamina, -1000f, "zzz");
        }
    }
}
